...
DEFAULT_CHECKPOINT_ROOT = _PROJECT_CFG.training.output_dir / "checkpoints"
DEFAULT_DATASET_ROOT = _PROJECT_CFG.dataset.lerobot_root / _PROJECT_CFG.dataset.repo_id.split("/")[-1]
DEFAULT_OUTPUT = Path(os.environ.get("S4_OUTPUT_ROOT", PROJECT_ROOT / "outputs")) / "eval/offline_policy_preview.csv"
